    ...
    class ShortUrl
    {
        ...
        public static string WithGoogl(string url)
        {
            ...
            using (StreamReader responseReader = new StreamReader(responseStream))
            {
                ...
                //"{""short_url"":""([^""]*)""}"
                string x = Regex.Match(json, @"\b(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|$!:,.;]*[a-zA-Z0-9+&@#/%=~_|$]").Value;
                return x;
            }
        }
